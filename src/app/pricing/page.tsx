...
export default function PricingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-green-700 text-white p-4 sm:p-8">
        ...
        <Card className="w-full bg-white/10 border-white/20 backdrop-blur-sm text-white">
          <CardContent className="p-6">
            <div className="space-y-6">
              ...
              <div>
                <Label htmlFor="access-code" className="text-left block mb-2 font-semibold">Insira seu código de acesso</Label>
