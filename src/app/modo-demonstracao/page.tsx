    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-[hsl(var(--primary))] to-green-950 text-white p-4 sm:p-8">
        ...
        <div className="max-w-md mx-auto flex flex-col items-center text-center">
          <h1 className="text-3xl sm:text-5xl font-bold mt-12 text-white">Modo de Demonstração</h1>
          <p className="text-lg text-slate-200 mt-2">Gere dezenas livremente para suas gravações.</p>
          ...
          <div className="w-full space-y-6 bg-white/90 p-6 rounded-lg shadow-xl text-black">
            ...
            >
              {isGenerating ? <Loader2 className="animate-spin" /> : <><Ticket className="mr-2" /> GERAR DEZENAS (DEMO)</>}
            </Button>
            <p className="text-xs text-slate-500 text-center">
              Esta é uma página de demonstração. Nenhuma validação de código ou cobrança é realizada aqui.
            </p>
          </div>
        </div>
      </div>
